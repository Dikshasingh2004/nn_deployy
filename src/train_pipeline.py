...
from preprocessing.data_management import load_dataset, save_model

import pipeline as pl

# Initialize placeholders for various parameters
...
def run_training(tol, epsilon):
    ...
    while True:
        ...
        for i in range(X_train.shape[0]):
            ...
            del_L_by_del_h[config.NUM_LAYERS - 1] = (h[config.NUM_LAYERS - 1] - Y_train[i])
...
if __name__ == "__main__":
    run_training(config.tol, config.epsilon)
